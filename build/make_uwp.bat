...
cmake -G "Visual Studio 17 2022" -A Win32 -DLUAC_COMPATIBLE_FORMAT=ON -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=10.0 ..
popd
...
cmake -G "Visual Studio 17 2022" -A x64 -DLUAC_COMPATIBLE_FORMAT=ON -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=10.0 ..
popd
...
cmake -G "Visual Studio 17 2022" -A ARM -DLUAC_COMPATIBLE_FORMAT=ON -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=10.0 ..
popd
...
cmake -G "Visual Studio 17 2022" -A ARM64  -DLUAC_COMPATIBLE_FORMAT=ON -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=10.0 ..
popd
