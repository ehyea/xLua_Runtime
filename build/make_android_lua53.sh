...
function build() {
    ...
    cmake -H. -B${BUILD_PATH} -DANDROID_ABI=${ABI} -DLUAC_COMPATIBLE_FORMAT=ON -DCMAKE_BUILD_TYPE=Release -DCMAKE_TOOLCHAIN_FILE=${NDK}/build/cmake/android.toolchain.cmake -DANDROID_NATIVE_API_LEVEL=${API} -DANDROID_TOOLCHAIN=gcc -DANDROID_TOOLCHAIN_NAME=${TOOLCHAIN_ANME}
...
build android-16 x86_64 x86_64-4.9
